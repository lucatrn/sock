...
namespace SoLoud
{
	...
	public:
		...
		// Set a live filter. Pass null to remove.
		// The filter pointer is not held by soloud, it can be released as soon as this method returns.
		void setFilter(handle aVoiceHandle, unsigned int aFilterId, Filter* filter);
